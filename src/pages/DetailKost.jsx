...
export default function DetailKost() {
  ...
  const baseHarga = isKost1 ? 1200000 : 1000000;
  ...
  const kostData = {
    nama: isKost1 ? "Kost Putri Melati" : `Kost Dummy ID: ${id}`,
    hargaStr: formatRupiah(baseHarga),
    lokasi: isKost1 ? "Jl. Cihampelas No. 42, Bandung Utara · 800m dari UNPAD" : "Lokasi Tidak Diketahui",
    rating: "4.8",
    images: isKost1 ? [imgUtama, imgKamar1, imgMandi1, imgWastafel, imgKamar2] : [null, null, null, null, null],
    kategoriGaleri: isKost1 ? [
    ...
    <div className="detail-page-wrapper">
      ...
      <main className="detail-container">
        <div className="detail-title-area">
          <div className="breadcrumb">Beranda &gt; Cari Kost &gt; {kostData.nama}</div>
            ...
            <div className="content-card">
              ...
              <p className="desc-text">
                {isKost1
                  ...
                  : "Deskripsi kost belum ditambahkan oleh pemilik."}
              </p>
              <div className="info-boxes">
                <div className="info-box"><span>Jenis</span><strong>{isKost1 ? "Putri" : "Campur"}</strong></div>
          ...
          <div className="right-sidebar">
            <div className="checkout-card">
              ...
              <div className="escrow-notice">
                ...
                Deposit {kostData.hargaStr} akan disimpan aman oleh SecuraKost Escrow. Dikembalikan otomatis jika kontrak berakhir normal.
              </div>
              <div className="owner-profile">
                <div className="owner-avatar">BW</div>
                <div className="owner-info">
                  <strong>Bu Wati Santoso</strong>
                  <span>
